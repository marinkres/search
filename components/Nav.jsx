  ...
  return (
    <nav className='flex-between w-full mb-16 pt-3'>
      <Link href='/' className='flex gap-2 flex-center'>
        ...
        />
        <p className='logo_text ' style={{ color: '#FFF8F0'}}>PoseriSe</p>
      </Link>
    ...
    {/* Modal content */}
      ...
      `}</style>
        ...
        <p className="text-center" style={{ color: '#99aab5' }}>
          Prijavom na PoseriSe pristajete na naše{' '}
          <a href="/assets/documents/terms_of_use_rejtajhr.pdf" target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'underline' }}>
